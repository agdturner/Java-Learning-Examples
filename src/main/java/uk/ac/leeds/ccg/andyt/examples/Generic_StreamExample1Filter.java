/*
 * Copyright (C) 2018 Andy Turner, Uiversity of Leeds.
 *
...
/**
 * A simple example for filtering an input stream. For more excellent examples
 * of Stream processing please see Joey James' tutorial and code:
 * https://youtu.be/t1-YZ6bF-g0
 * https://github.com/joeyajames/Java/blob/master/Java%208%20Streams/JavaStreams.java
 * @author Andy Turner
 */
public class Generic_StreamExample1Filter {
